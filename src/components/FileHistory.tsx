...
import { shortHash, formatRelativeTime as formatTime } from "@/utils/format";
    ...
    on(
      ...
      async (path) => {
        ...
        try {
          ...
          setError(err instanceof Error ? err.message : "获取文件历史失败");
        } finally {
          setLoading(false);
        }
      },
                        ...
                        {(d) => (
                          <For each={d().files}>
                            {(file) => (
                              ...
                              >
                                <div
                                  style={{ "border-bottom": "1px solid var(--gs-border, #d0d7de)" }}
                                >
                                  <div
                                    style={{
                                      padding: "6px 16px",
